...
Now let's create an [AddressCredentialV1](https://github.com/getunid/unid-docs/tree/e7fb1b3ad25103722358ceeb45984bbaf95da3da/content/schemas/address/README.md) through React Native SDKs.
...
In UNiD network, we ensure interoperability by referring to the VC data schema defined [here](https://github.com/getunid/unid-docs/tree/e7fb1b3ad25103722358ceeb45984bbaf95da3da/content/schemas/README.md). If you want to generate a new type of VC schema that is not in the UNiD VC schema list, you can request it. For more information, see [Request VC schema](https://github.com/getunid/unid-docs/tree/e7fb1b3ad25103722358ceeb45984bbaf95da3da/content/tutorial/3-howtorequestvcschema/README.md).
...
There are two main methods to submit VP to a verifier. The first one is to include the VP in the DID authentication response and submit it to a verifier. See more information in [the section of DID Communication](https://github.com/getunid/unid-docs/tree/e7fb1b3ad25103722358ceeb45984bbaf95da3da/content/wallet/3-did-auth/README.md). The second one is to storage the VP in SDS and grant access to the VP to the verifier.
